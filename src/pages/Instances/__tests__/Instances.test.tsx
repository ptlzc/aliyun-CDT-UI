...
describe('InstancesPage CDT free quota card', () => {
  ...
  it('does not render the CDT card when accountId is not provided', () => {
    ...
    render(<InstancesPage instances={[]} onManageInstance={() => {}} />);

    expect(screen.queryByText('CDT 免费额度')).not.toBeInTheDocument();
  });
});

describe('InstancesPage effective governance source layer badge', () => {
