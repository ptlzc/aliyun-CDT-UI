...
export type DiscoverTopologyData = {
    body?: never;
    path: {
        accountId: string;
    };
    query?: never;
    url: '/api/accounts/{accountId}/discover';
};

export type DiscoverTopologyErrors = {
    /**
     * Error
     */
...
export type DiscoverTopologyError = DiscoverTopologyErrors[keyof DiscoverTopologyErrors];

export type DiscoverTopologyResponses = {
    /**
     * OK
     */
    200: ResourceGraph;
...
export type DiscoverTopologyResponse = DiscoverTopologyResponses[keyof DiscoverTopologyResponses];
...
export type GetGraphData = {
    ...
    query?: never;
    url: '/api/accounts/{accountId}/graph';
};
...
export type GetInventoryGraphData = {
    body?: never;
    path: {
        accountId: string;
    };
    query?: never;
    url: '/api/accounts/{accountId}/graph/inventory';
};

export type GetInventoryGraphErrors = {
    /**
     * Error
     */
    default: ErrorResponse;
...
export type GetInventoryGraphError = GetInventoryGraphErrors[keyof GetInventoryGraphErrors];

export type GetInventoryGraphResponses = {
    /**
     * OK
     */
    200: ResourceGraph;
...
export type GetInventoryGraphResponse = GetInventoryGraphResponses[keyof GetInventoryGraphResponses];
